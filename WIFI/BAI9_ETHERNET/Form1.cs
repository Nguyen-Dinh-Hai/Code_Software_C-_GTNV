...
namespace BAI9_ETHERNET
{
    public partial class Form1 : Form
    {
        ...
        private void Receive()
        {
            try
            {
                while(true)
                {
                    ...
                    if ( s== "a")
                    {
                        pictureBox1.Image = BAI9_ETHERNET.Properties.Resources.dongcoon;
                    }
                    else if (s == "d")
                    {
                        pictureBox1.Image = BAI9_ETHERNET.Properties.Resources.dongcooff;
                    }
                }
            }
            catch(Exception)
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                datasend = Encoding.ASCII.GetBytes("a");
                client.Send(datasend, datasend.Length, SocketFlags.None);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                datasend = Encoding.ASCII.GetBytes("d");
                client.Send(datasend, datasend.Length, SocketFlags.None);
        ...
        private void textBox_ServerIP_1_TextChanged(object sender, EventArgs e)
        {
