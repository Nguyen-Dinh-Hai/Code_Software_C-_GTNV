...
namespace USB5
{
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult answer = MessageBox.Show("DO YOU WAN EXITS ?", " Quesion ", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void bnton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("DECIVE NOT FOUND. PLEASE RECONNECT USB DECIVE TO USE.", " Information ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
